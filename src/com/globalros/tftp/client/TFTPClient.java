...
import com.globalros.tftp.common.*;
...
public class TFTPClient {
     ...
     * @throws IOException
     */
    public boolean download(RRQ rrq, OutputStream os, Long fileSize, MainWindow mainWindow) throws SocketException, InstantiationException, IOException {
        // create a TFTP Socket
        TFTPSocket tftpSock = new TFTPSocket(5);

        this.mainWindow = mainWindow;

        Long actualDownloadSize = 0L;
        ...
        if (surprisePacket instanceof OACK) {
            ...
            mainWindow.updateDownload(actualDownloadSize, fileSize);
        }
     ...
     * @throws IOException
     */
    public boolean upload(WRQ wrq, InputStream is, Long fileSize, MainWindow mainWindow) throws SocketException, InstantiationException, IOException, InterruptedException {
        ...
        while ((returnValue = is.read(sendBytes)) != -1) {
            ...
            mainWindow.updateUpload(actualUploadSize, fileSize);
        }
